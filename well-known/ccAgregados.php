...
$privileges = DB::table('caja_compesacion')->select()->get();
			...
			<div class="row">
				<div class="col-md-12">
					<div class="head_section">
						<h3>Caja Compensacion</h3>
						<a  style="float:right;padding:12px" class="btn btn-bapp" href="caja_compesacion.php">Nuevo</a>
						</div>
					</div>
				</div>
			</div>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php foreach($array as $row){ ?>
                            <tbody>
                                ...
                                <td>
                                    <button id="btn" class="btn btn-danger" onclick="deleteUser(<?php echo $row['id'];?>, 'Esta seguro que desea eliminar este seguro?', 'app/Controllers/controllerDeleteCaja.php', <?php echo $priv; ?>)"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
