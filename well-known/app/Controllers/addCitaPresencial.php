...
$cita = new Cita;
$cita->addCitaPresencial($date,$time,$email,$place,$id_postulante);
$_SESSION['c'] = "Usted ha agreado un nueva cita presencial satisfactoriamente";
$template = 
'
            ...
            <tr>
                <td>
                    <div>
                       ...
                       <strong>Link de examen:</strong> <a href="'.$url.'">Rendir Examen Aqui</a><br><br></p>
...
// título
$título = 'Entrevista Bapp - Presencial';
...
$n->Notificacion("Se ha creado una nueva entrevista presencial para el usuario $name ", $name);
