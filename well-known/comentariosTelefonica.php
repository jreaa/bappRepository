...
//statuentrevista
$sentrevista = DB::table('status_entrevista_telefonica')->where('id', '=', $_GET['id'])->get();
...
//entrevista
$entrevista = DB::table('tblcita_telefonica')->where('id', '=', $id_e)->get();
...
<section class="mt-5">
	<div class="container">
		<div class="content">
				...
				<div class="card">
				    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php 
                                $comment = DB::table('comentarios_entrevista_telefonica')->where('id_entrevista', '=', $id_comments )->get();
                ...
                <form class="mt-3" action="app/Controllers/comentarioTelefonica.php" method="POST">
