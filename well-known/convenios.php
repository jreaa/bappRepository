...
<div class="mt-5">
	<div class="container">
		<div class="content">
			<div class="row">
				<div class="col-md-12">
					<form class="form-group" action="app/Controllers/convenio.php" method="post" enctype="multipart/form-data">
						<div class="mb-3">
	...
	<?php if(!empty($convenio)){?>
		<div class="container">
			<h4 class="text-center mt-3 mb-3">Convenios</h4>
			<div class="brand">
			<?php foreach($convenio as $row): ?>
