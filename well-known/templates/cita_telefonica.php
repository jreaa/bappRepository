	...
	<div class="form-group">
		<div class="row">
			<div class="col-sm-6">
				...
				<select name="link" class="mb-2 form-control" id="link" required>
...
<div class="modal" tabindex="-1" id="modal1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" id="formSend" action="app/Controllers/addCitaTelefonica.php">
...
<script type="text/javascript" src="js/modalCitaTelefonica.js"></script>
