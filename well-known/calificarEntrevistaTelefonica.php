...
//entrevista
$entrevista = DB::table('tblcita_telefonica')->where('Id', '=', $_GET['id'])->get();
...
<section class="mt-5">
  <div class="container">
    <div class="content">
      <form class="form-group" method="POST" action="app/Controllers/EnviarResultados.php">
       ...
       <div class="card">
           <div class="card-body">
                ...
                <input type="date" class="form-control" value="<?php echo $row['fecha'];?>" readonly>
                <label>Status</label>
                ...
                <label for="comentario">Comentarios sobe el participante</label>
                <textarea cols="5" name="comentario" class="form-control"><?=$row['comentario'];?></textarea>
                ...
                <label for="comentario_add">Comentarios adicionales</label>
                <textarea cols="5" name="comentario_add" class="mb-5 form-control">
