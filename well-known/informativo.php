...
$v =json_decode (json_encode(DB::table('informativo')->where("status", $estado)->get()),True);
...
<div class="mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php 
                            ...
                            $postulante = DB::table('postulante')->select()->where('id','=',$row['id_usuario_informativo'])->get();
    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-body">
             <form method="POST" action="app/Controllers/addInformativo.php" enctype="multipart/form-data" >
                <table class="table">
                <thead>
                    <tr>
                    <th scope="col">Usuario</th>
                    <th scope="col">Fecha informativo</th>
                    <th scope="col">Hora informativo</th>
                    <th scope="col">Archivo Adicional</th>
                    <th scope="col">Pautas informativo</th>
                    ...
                    <tbody>
                        ...
                        <td>
                            <?php 
                             ...
                             $inductivo = json_decode (json_encode(DB::table('informativo')->select()->get()),True);
                             $p = [];
                             $ccid = [];
                             for($i=0;$i<sizeof($inductivo);$i++){
                                array_push($ccid,$inductivo[$i]['id_usuario_informativo']);
                            }
        ...
        <?php foreach($v as $row) { ?>
			...
			<div class="modal" tabindex="-1" id="modal<?php echo $row['id'];?>">
				<div class="modal-dialog modal-xl">
					<div class="modal-content ">
                        <div class="modal-body">
                            <form method="POST" action="app/Controllers/editInformativo.php">
                               <table class="table">
                                <thead>
                                    <tr>
                                    <th scope="col">Usuario</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <select class="form-control" name="cc">
                                             <?php
                                                $veh =json_decode (json_encode(DB::table('postulante')->where("id", $row['id_usuario_informativo'])->select()->get()),True);
                                                foreach($veh as $ve){ ?>
                                                <?php 
