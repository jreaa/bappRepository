...
$test = DB::table('test')->where('title', '=', $_GET['title'])->get();
...
<div class="mt-5">
	<div class="container">
		<div class="content">
		    <a class="btn btn-bapp" style="float:right" href="seeTest.php?id=<?php echo $id ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
